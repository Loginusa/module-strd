...
public class GspGetHitungWasteSebalikna extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    hasilKali = desimalWaste.multiply(new BigDecimal("100"));
    hasilWaste  = hasilKali.divide(desimalaterial);
 
    // inject the result into the response
    info.addResult("inpwasteCostP",hasilWaste.toString());
