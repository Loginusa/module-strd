...
public class GspGetHitungSebalikna extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    hasilKali = desimalAvalan.multiply(new BigDecimal("100"));
    hasilAvalan  = hasilKali.divide(desimalaterial);
 
    // inject the result into the response
    info.addResult("inpavalanP",hasilAvalan.toString());
