...
public class GspGetHitungFreightSebalikna extends SimpleCallout {
  ...
  BigDecimal desimalFreight = info.getBigDecimalParameter("inpfreightV");
    ...
    hasilKali = desimalFreight.multiply(new BigDecimal("100"));
    hasilFreight  = hasilKali.divide(desimalNetsales);
    ...
    info.addResult("inpfreightP",hasilFreight.toString());
