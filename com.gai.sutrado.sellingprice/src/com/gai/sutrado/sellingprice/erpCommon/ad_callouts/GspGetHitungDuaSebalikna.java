...
public class GspGetHitungDuaSebalikna extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    BigDecimal desimalFixCoast = info.getBigDecimalParameter("inpfixCostV");
    ...
    hasilKali = desimalFixCoast.multiply(new BigDecimal("100"));
    hasilTambah = desimalaterial.add(desimalPacking);
    hasilFixCoast  = hasilKali.divide(hasilTambah);
    ...
    info.addResult("inpfixCostP",hasilFixCoast.toString());
