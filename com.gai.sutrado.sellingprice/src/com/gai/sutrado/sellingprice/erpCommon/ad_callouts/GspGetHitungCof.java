...
public class GspGetHitungCof extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    BigDecimal desimalCos = info.getBigDecimalParameter("inpcofP");
    ...
    hasilBagi = desimalCos.divide(new BigDecimal("100"));
    hasilCof  = hasilTambah.multiply(hasilBagi);
 
    // inject the result into the response
    info.addResult("inpcofV",hasilCof.toString());
